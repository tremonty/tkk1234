			...
			foreach ($modern_filter as $modern_filter_unit) {
				...
				<?php } else { ?>
					...
					<?php if (!empty($modern_filter_unit['use_on_car_modern_filter_view_images'])){ ?>
						...
						<div class="stm-accordion-single-unit stm-modern-filter-unit-images <?php echo esc_attr($modern_filter_unit['slug']); ?>">
							<a class="title <?php echo (esc_attr($listing_rows_numbers_default_expanded) == 'false') ? 'collapsed':''?>" data-toggle="collapse"
							   href="#<?php echo esc_attr($modern_filter_unit['slug']) ?>" aria-expanded="<?php echo esc_attr($listing_rows_numbers_default_expanded); ?>">
								<h5><?php esc_html_e($modern_filter_unit['single_name'], 'motors'); ?></h5>
								<span class="minus"></span>
							</a>
							<div class="stm-accordion-content">
								<div class="collapse content <?php echo (esc_attr($listing_rows_numbers_default_expanded) == 'true') ? 'in':''?>" id="<?php echo esc_attr($modern_filter_unit['slug']); ?>">
									<div class="stm-accordion-content-wrapper">
                ...
                <?php } else { ?>
					...
					<?php
							...
							<div class="stm-accordion-single-unit stm-modern-dynamic-slider stm-modern-price-unit <?php echo esc_attr($slug); ?>" data-slider-name="<?php echo esc_attr($slug); ?>">
								<a class="title" data-toggle="collapse"
								...
								<div class="stm-accordion-content">
									<div class="collapse in content" id="<?php echo esc_attr($slug); ?>">
										<div class="stm-accordion-content-wrapper stm-modern-filter-<?php echo esc_attr($slug); ?>">
											...
											<div class="row">
												<div class="col-md-6 col-sm-6 col-md-wider-right">
													<input type="text" name="min_<?php echo esc_attr($slug); ?>" id="stm_filter_min_<?php echo esc_attr($slug); ?>" readonly/>
												</div>
												<div class="col-md-6 col-sm-6 col-md-wider-left">
													<input type="text" name="max_<?php echo esc_attr($slug); ?>" id="stm_filter_max_<?php echo esc_attr($slug); ?>" readonly/>
												</div>
											</div>
										</div>
									</div>
