		...
		<div class="media-widget-list clearfix">
			<?php foreach ( $images as $attach_id ):
				...
				<div class="media-widget-item">
					...
					?>
					<a class="stm_fancybox" href="<?php echo esc_url($fancy_link); ?>" title="<?php esc_attr_e('Watch in popup', 'motors'); ?>" rel="<?php echo esc_attr($image_gallery); ?>">
						<img src="<?php echo esc_url($thumbnail); ?>" class="img-responsive" alt="<?php esc_attr_e('Media gallery image','motors'); ?>"/>
					</a>
				</div>
