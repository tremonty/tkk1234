...
?>
    ...
    <div class="stm-service-layout-info-box <?php echo esc_attr($css_class); ?>" <?php echo stm_do_lmth($box_bg_style); ?>>
        <div class="inner" <?php echo stm_do_lmth($image); ?>>
            <?php if (!empty($title)): ?>
                <div class="title heading-font" <?php echo stm_do_lmth($title_color); ?>><?php echo esc_attr($title); ?></div>
            <?php endif; ?>

            <?php if (!empty($price_value)): ?>
                <div class="service-price heading-font" <?php echo stm_do_lmth($price_style); ?>>
