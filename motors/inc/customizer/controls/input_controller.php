	...
	function stm_input($args = array())
	{
		...
		switch ($input['type']) {
			...
			case 'socials' : ?>
				...
				<input type="hidden" <?php echo stm_do_lmth($input_props['data']); ?> value=""/>
			...
			case 'multiple-checkbox' : ?>
				...
				<input type="hidden" <?php echo stm_do_lmth($input_props['data']); ?>
            ...
            case 'text-repeater' : ?>
				<ul class="stm-diff-currency-list">
                    ...
                    ?>
                            ...
                            <li class="stm-tr-<?php echo esc_attr($q); ?>">
                                <label>
                                ...
                                <span class="stm-text-repeater-remove" data-position="<?php echo esc_attr($q); ?>">
