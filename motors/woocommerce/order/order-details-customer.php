...
<address>
	<?php echo ( !empty($address = $order->get_formatted_billing_address()) ) ? $address : __( 'N/A', 'motors' ); ?>
</address>
	...
	<div class="col-2">
		...
		<address>
			<?php echo ( !empty($address = $order->get_formatted_shipping_address()) ) ? $address : __( 'N/A', 'motors' ); ?>
		</address>
	</div><!-- /.col-2 -->
</div><!-- /.col2-set -->
