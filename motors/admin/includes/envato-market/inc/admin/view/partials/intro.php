...
<div class="two-col">
	<div class="col">
		<h1 class="about-title"><strong><?php esc_html_e( 'Envato Market', 'motors' ); ?></strong> <sup><?php echo esc_html( envato_market()->get_version() ); ?></sup></h1>
		<p><?php esc_html_e( 'Welcome!', 'motors' ); ?></p>
		<p><?php esc_html_e( 'This plugin can install WordPress themes and plugins purchased from ThemeForest & CodeCanyon by connecting with the Envato Market API using a secure OAuth personal token. Once your themes & plugins are installed WordPress will periodically check for updates, so keeping your items up to date is as simple as a few clicks.', 'motors' ); ?></p>
		...
		<p><strong><?php printf( esc_html__( 'Development of this plugin is done on %sGitHub%s. Pull requests welcome.', 'motors' ), '<a href="https://github.com/envato/wp-envato-market" target="_blank">', '</a>' ); ?></strong></p>
	</div>
	<div class="col screenshot-image">
		<span><?php esc_html_e( 'Active Theme', 'motors' ); ?></span>
