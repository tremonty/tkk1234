...
if (!empty($checkboxes)) {
    foreach ($checkboxes as $checkbox) {
        ...
        <div
            ...
            <a class="title <?php echo (esc_attr($listing_rows_numbers_default_expanded) == 'false') ? 'collapsed':''?> " data-toggle="collapse" href="#accordion-<?php echo esc_attr($checkbox['slug']); ?>"
