...
?>
<div
    class="<?php echo esc_attr($colClass); ?> col-xs-12 col-xxs-12 stm-directory-grid-loop stm-isotope-listing-item all <?php if(!empty($asSold)) echo esc_attr('car-as-sold');?> <?php print_r(implode(' ', $classes)); ?> <?php print_r(implode(' ', $class)); ?>"
